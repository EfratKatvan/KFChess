...
def main() -> None:
    ...
    # Skin choice and login/registration both happen in the game window
    # itself (skin_menu then login_entry phases) - see
    # network_client_view.run_client's own docstring. No shell prompt
    # anymore; the window opens immediately.
